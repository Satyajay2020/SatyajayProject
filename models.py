...
class Show(db.Model):
    ...
    venue_id = db.Column(db.Integer, db.ForeignKey('venue.id'),
                         nullable=False)  # pass venue obj here to gain access to all fields (wherever there is foreign key links)
    ...
    booking = db.relationship("Booking", backref="show",
                              cascade="all, delete")  # this will return a list of booking object for a given show
